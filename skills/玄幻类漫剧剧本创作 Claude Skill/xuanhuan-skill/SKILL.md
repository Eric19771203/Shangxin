...
name: xuanhuan-skill
version: 1.0.0
description: 玄幻类漫剧剧本创作技能包。执行大纲、人物、目录、章节的专业创作，基于玄幻题材创作法则和大气磅礴的写作风格生成高质量漫剧内容。
...
## 技能说明
专业的玄幻类漫剧剧本创作技能包，覆盖故事构思、人物塑造、章节规划、正文写作全流程。根据不同创作阶段，读取对应的创作资源并生成符合玄幻题材规范的漫剧内容。
...
- **专业创作**：基于资源和上下文创作符合玄幻题材规范的漫剧内容
- **风格把控**：确保创作内容符合玄幻题材的大气磅礴风格
- **模板遵循**：严格按照模板格式生成文档结构
