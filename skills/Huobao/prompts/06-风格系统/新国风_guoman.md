...
> **函数名**: `GetStylePrompt("guoman")`
> **源码位置**: `application/services/prompt_i18n.go:691-697 (中文) / 764-770 (英文)`
> **风格标识**: `guoman`
...
```
Modern Guofeng style, Oriental fantasy illustration, high-precision 2D digital painting,
silky texture, volumetric lighting, particle effects, glowing atmosphere,
indigo and golden orange color collision, local luminescence, bioluminescent elements,
flowing curves, light trails, ribbons, magical mysterious atmosphere
```
