...
> **函数名**: `GetStylePrompt("ghibli")`
> **源码位置**: `application/services/prompt_i18n.go:683-689 (中文) / 756-762 (英文)`
> **风格标识**: `ghibli`
...
```
Studio Ghibli style, watercolor texture, cel-shading, warm brushstrokes,
high-key color aesthetics, bright transparent palette, soft saturated hues,
summer afternoon natural lighting, blue-purple shadow tones,
nostalgic, serene, pastoral atmosphere, gentle breeze feeling
```
