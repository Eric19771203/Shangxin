...
> **函数名**: `GetStylePrompt("urban")`
> **源码位置**: `application/services/prompt_i18n.go:731-737 (中文) / 804-810 (英文)`
> **风格标识**: `urban`
...
|------|------|
| 质感 | 极干净矢量线条、平滑数字皮肤 |
| 色彩 | 冷调都市灰（黑白灰深蓝）+ 霓虹荧光反差 |
| 光影 | 硬边赛璐珞阴影、边缘光（Rim lighting） |
| 氛围 | 高冷、精致、工业化美感、深夜都市疏离 |
...
```
Modern webtoon art style, crisp vector line art, clean digital skin,
no redundant strokes, smooth texture,
muted urban tones, black white gray deep blue, neutral palette,
high-contrast neon accents, neon glow, pink blue purple highlights,
late-night urban detachment,
hard cel-shading, crisp shadow edges, no gradients,
environmental rim lighting, neon sign side light,
high-cold sophisticated industrial-chic aesthetic
```
