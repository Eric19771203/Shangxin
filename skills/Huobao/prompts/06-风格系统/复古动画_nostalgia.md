# 90年代复古动画风格 (nostalgia)

> **函数名**: `GetStylePrompt("nostalgia")`
> **源码位置**: `application/services/prompt_i18n.go:707-713 (中文) / 780-786 (英文)`
> **风格标识**: `nostalgia`
...
```
90s retro anime style, nostalgic cel-shading, film grain, chromatic aberration,
VHS tape texture, imperfect delicate lines, handcrafted warmth,
muted pastel palette, lavender, lotus pink, grayish-blue,
no pure blacks, weakened black point, dreamlike twilight,
diffuse point lights, soft hazy glow, post-rain reflections,
lonely but cozy, urban dusk atmosphere
```
