...
> **函数名**: `GetStylePrompt("chibi3d")`
> **源码位置**: `application/services/prompt_i18n.go:747-753 (中文) / 820-826 (英文)`
> **风格标识**: `chibi3d`
...
```
3D blind box art style, toy art figurine, chibi proportions,
large head small body, plastic and resin texture,
rounded smooth surfaces, subtle beveled edges,
muted vibrant palette, vivid but not piercing colors,
natural base colors, forest green, earth brown,
soft even top lighting, key light on front,
ambient occlusion in crevices, weight and realism,
sophisticated cute tactile, digital art toy aesthetic
```
