...
> **函数名**: `GetStylePrompt("wasteland")`
> **源码位置**: `application/services/prompt_i18n.go:699-705 (中文) / 772-778 (英文)`
> **风格标识**: `wasteland`
...
|------|------|
| 质感 | 硬缘线条、颗粒状平面印刷感 |
| 色彩 | 低频限色（灰土/铁锈橙/荒漠黄）+ 单点高亮 |
| 光影 | 高对比度强侧光、极长投影 |
| 氛围 | 荒凉、压抑、干枯、灼热、寂静 |
| 灵感来源 | Moebius（让·吉罗）、末世科幻 |
...
```
Post-apocalyptic wasteland style, hard-edged line art, bold black outlines,
grainy flat-print texture, retro poster feel, hatching shadows,
limited color palette, dusty earth tones, rust orange, desert yellow,
single high-contrast accent color, high-contrast side lighting,
long dramatic shadows, desolate epic atmosphere, Moebius inspired
```
